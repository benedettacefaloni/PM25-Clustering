...
def main():
    ...
    pm25_timeseries = yearly_data_as_timeseries(data) # creating a matrix (pm25_timeseries) that represents the pm2.5 values for each station over the entire year, organized in a time series format.
