...
test the two cohesion functions 3 and 4 of \cref{subsec:PPMxClusteringCohesionFuctions} in our large experiment.\footnote{Cf.
\cite[Section 4.2]{Page2021-Temporal} for more details.}
As before, we results are comprehensively available in the Github repository and \cref{tab:DRPMSpatialBaselineSummary}
